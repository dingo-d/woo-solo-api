...
?>
<input id="options" type="radio" name="tabs" />
<label for="options"><?php _e('Solo API options', 'woo-solo-api'); ?></label>
<div class="content">
	<div class="left">
		<div class="option">
			<label for="measure" class="subtitle">
		...
		<div class="option">
			<label for="languages" class="subtitle"><?php esc_html_e('Languages', 'woo-solo-api'); ?></label>
		...
		<div class="option">
			<label for="currency" class="subtitle"><?php esc_html_e('Currency', 'woo-solo-api'); ?></label>
	...
	<div class="right">
		<div class="option">
			<label for="service-type" class="subtitle">
		...
		<div class="option">
			<label for="show-taxes" class="subtitle"><?php esc_html_e('Show taxes', 'woo-solo-api'); ?></label>
		...
		<div class="option">
			<label for="invoice-type" class="subtitle">
		...
		<div class="option">
			<label for="due-date" class="subtitle">
